                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return StreamBuilder<List<TaskRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<TaskRecord> taskTaskRecordList =
                                      snapshot.data!;
                                  // Return an empty Container when the item does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  }
                                  final taskTaskRecord =
                                      taskTaskRecordList.isNotEmpty
                                          ? taskTaskRecordList.first
                                          : null;

                                  return TaskWidget(
                                    key: Key(
                                        'Keyera_${listViewIndex}_of_${listViewTaskRecordList.length}'),
